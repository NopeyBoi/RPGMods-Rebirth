...
public class HunterHunted
{
    ...
    public static void PlayerUpdateHeat(Entity killerEntity, Entity victimEntity)
    {
        ...
        FactionReference victim = entityManager.GetComponentData<FactionReference>(victimEntity);
        PrefabGUID victim_faction = victim.FactionGuid._Value;
    ...
    public static void HeatManager(Entity userEntity, Entity playerEntity, bool InCombat)
    {
        ...
        _ = Cache.player_heat_timestamp.TryGetValue(SteamID, out last_update);
        _ = Cache.player_last_ambushed.TryGetValue(SteamID, out last_ambushed);
        _ = Cache.bandit_last_ambushed.TryGetValue(SteamID, out bandit_last_ambush);
        ...
        if (elapsed_time.TotalSeconds > cooldown_timer)
        {
            ...
            int player_heat;
            _ = Cache.heatlevel.TryGetValue(SteamID, out player_heat);
            if (player_heat > 0)
            {
            ...
            _ = Cache.bandit_heatlevel.TryGetValue(SteamID, out player_banditheat);
