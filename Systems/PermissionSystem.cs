...
public static class PermissionSystem
{
    ...
    {
        bool isExist = Database.user_permission.TryGetValue(steamID, out int permission);
    ...
    {
        bool isExist = Database.command_permission.TryGetValue(command, out int requirement);
