...
public class Plugin : BasePlugin, IRunOnInitialized
{
    ...
    public void InitConfig()
    {
        ...
        if (!Directory.Exists("BepInEx/config/RPGMods")) _ = Directory.CreateDirectory("BepInEx/config/RPGMods");
        if (!Directory.Exists("BepInEx/config/RPGMods/Saves")) _ = Directory.CreateDirectory("BepInEx/config/RPGMods/Saves");

        if (!File.Exists("BepInEx/config/RPGMods/kits.json"))
        {
            FileStream stream = File.Create("BepInEx/config/RPGMods/kits.json");
            stream.Dispose();
        }
    }
